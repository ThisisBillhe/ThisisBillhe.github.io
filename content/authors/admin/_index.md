...
name_pronunciation: Yeh-fei Heh 
...
profiles:
  - icon: at-symbol
    url: 'mailto:billhe@zju.edu.cn'
    label: E-mail Me
  - icon: brands/x
    url: https://twitter.com/yefei_he
  # - icon: brands/instagram
  #   url: https://www.instagram.com/
  - icon: brands/github
    url: https://github.com/ThisisBillhe
  # - icon: brands/linkedin
    # url: https://www.linkedin.com/
  - icon: academicons/google-scholar
    url: https://scholar.google.com/citations?user=CTEQwwwAAAAJ&hl=zh-CN
